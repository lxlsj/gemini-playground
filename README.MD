...
```
Author: ChrisKyle
Project: https://github.com/defgh/gemini-2-live-api-demo
MIT License : https://github.com/defgh/gemini-2-live-api-demo/blob/main/LICENSE
```

Gemini转成OpenAI格式： 
```
Author: PublicAffairs
Project: https://github.com/abc/openai-gemini
MIT License : https://github.com/abc/openai-gemini/blob/main/LICENSE
```
